...
namespace Siemens.OpcUA
{
    public class Subscription
    {
        ...
        public void AddDataMonitoredItem(NodeId variableNodeId, object clientHandle, uint samplingRate, out object serverHandle)
        {
            serverHandle = null;
            ...
            try
            {
                ...
                monitoredItem.QueueSize = 10;///  这个队列干嘛的不知道?
