...
namespace Siemens.OpcUA
{
    ...
    /// </summary>
    public delegate void DataChangedEvent(List<object> clientHandleList, List<DataValue> valueList);
    ...
    public class Server
    {
        ...
        public event DataChangedEvent DataChangedEvent = null;
        ...
        public Subscription AddSubscription(int publishingInterval)
        {
            ...
            try
            {
                ...
                m_Session.Notification += new NotificationEventHandler(DataChangedNotification);
